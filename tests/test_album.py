...
class AlbumTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.album4 = Album(
            titulo="La cultura de la basura",
            ano=1987,
            descripcion="No tiene",
            medio=Medio.DISCO,
            canciones=[],
    ...
    def test_verificar_almacenamiento_agregar_album(self):
        ...
        album = (
            ...
            .filter(Album.titulo == "Signos" and Album.medio == Medio.DISCO)
            .first()
        )
